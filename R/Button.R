    ...
    public = list(
      initialize = function(
        ...
        private$state_ <- update_list(
          ...
          font_style   = rlang::arg_match(font_style, values = accepted_font_style, error_call = error_call),
          font_variant = rlang::arg_match(font_variant, values = accepted_font_variant, error_call = error_call),
          font_weight  = {
  ...
  public = list(
    ...
    initialize = function(
      ...
      private$state_ <- update_list(
        ...
        button_style = arg_match(button_style, error_call = error_call),
